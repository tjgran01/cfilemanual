...
In order to perform the above analysis, you will need three things – the **<strong>onset</strong> of the stimulus**, the **<strong>duration</strong> of the stimulus** and, something to identify **what the stimulus (<strong>stim</strong>) was**. The three bolded words in the prior sentence are needed in every conditions file, and as a result will be the first three rows generated in every conditions file made.
